...
def test_lossless_rebuild():
    ...
    compressed_file = "integrity_test_copy.cdv6"
    ...
    print(f"\n[2] Executing CyberDNA V6 Deductive Compression...")
    compressor = CyberDNAVault()
    ...
    print(f"\n[3] Rebuilding / Decompressing from CubixOS Vault...")
