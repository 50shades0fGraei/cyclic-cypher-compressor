...
/**
 * CyberDNA: Codemap-loader.efi (Randall Bootloader)
...
efi_main (EFI_HANDLE ImageHandle, EFI_SYSTEM_TABLE *SystemTable) {
    ...
    Print(L"Step 4: Booting Tesseract-Core... Randallty Achieved.\n");
