...
Write-Host "   INITIALIZING RANDALL BUILD IN WSL SUBSYSTEM         " -ForegroundColor Cyan
Write-Host "=========================================================" -ForegroundColor Cyan
...
Write-Host "[2/3] Booting Randall Bridge and HTTP Server in Linux Subsystem..."

# Start Randall Bridge (Python backend api for UI)
Start-Process wsl.exe -ArgumentList "-e", "bash", "-c", "cd '$WslDir' && python3 randall_bridge.py" -WindowStyle Minimized
